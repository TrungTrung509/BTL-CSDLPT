...
VALUES ('HADONG', 'Cơ sở Hà Nội', 'Hà Nội', '0915548256', 'quanlyhadong@ptit.edu.vn', '2010-01-01', 'HoatDong')
ON CONFLICT ("MaCoSo") DO NOTHING;
INSERT INTO "CoSo" ("MaCoSo", "TenCoSo", "DiaChi", "SoDienThoai", "Email", "NgayThanhLap", "TrangThai")
VALUES ('NGOCTRUC', 'Cơ sở Ngọc Trục', 'Ngọc Trục', '0973987570', 'quanlyngoctruc@ptit.edu.vn', '2010-01-01', 'HoatDong')
ON CONFLICT ("MaCoSo") DO NOTHING;
INSERT INTO "CoSo" ("MaCoSo", "TenCoSo", "DiaChi", "SoDienThoai", "Email", "NgayThanhLap", "TrangThai")
VALUES ('HOALAC', 'Cơ sở Hòa Lạc', 'Hòa Lạc', '0937545392', 'quanlyhoalac@ptit.edu.vn', '2010-01-01', 'HoatDong')
ON CONFLICT ("MaCoSo") DO NOTHING;

-- ---- users ----
INSERT INTO "users" ("userId", "username", "password", "email", "role", "MaCoSo", "status")
VALUES ('HADONGADMIN001', 'admin_hadong', 'hashed_default_pass_123', 'admin.hadong@ptit.edu.vn', 'Admin', 'HADONG', 'Active')
ON CONFLICT ("userId") DO NOTHING;
INSERT INTO "users" ("userId", "username", "password", "email", "role", "MaCoSo", "status")
VALUES ('NGOCTRUCADMIN001', 'admin_ngoctruc', 'hashed_default_pass_123', 'admin.ngoctruc@ptit.edu.vn', 'Admin', 'NGOCTRUC', 'Active')
ON CONFLICT ("userId") DO NOTHING;
INSERT INTO "users" ("userId", "username", "password", "email", "role", "MaCoSo", "status")
VALUES ('HOALACADMIN001', 'admin_hoalac', 'hashed_default_pass_123', 'admin.hoalac@ptit.edu.vn', 'Admin', 'HOALAC', 'Active')
ON CONFLICT ("userId") DO NOTHING;
