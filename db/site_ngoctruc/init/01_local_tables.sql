...
-- Mô tả: Bảng cục bộ SITE NGOCTRUC (Ngọc Trục)
-- Thứ tự chạy: 01 (sau bảng common)
-- Mapping: NGOCTRUC -> site_ngoctruc
-- ============================================================

-- ============================================================
-- 1. BẢNG SinhVien - Sinh viên cơ sở Ngọc Trục
-- Phân mảnh ngang theo MaCoSo = 'NGOCTRUC'
-- ============================================================
CREATE TABLE IF NOT EXISTS SinhVien (
    ...
    DiaChi VARCHAR(300),
    MaCoSo VARCHAR(10) NOT NULL DEFAULT 'NGOCTRUC',
    MaKhoa VARCHAR(20),
...
COMMENT ON TABLE SinhVien IS 'Sinh viên cơ sở NGOCTRUC - PHÂN MẢNH NGANG theo MaCoSo';

-- ============================================================
-- 2. BẢNG GiangVien - Giảng viên cơ sở Ngọc Trục
-- Phân mảnh ngang theo MaCoSo = 'NGOCTRUC'
-- ============================================================
...
COMMENT ON TABLE GiangVien IS 'Giảng viên cơ sở NGOCTRUC - PHÂN MẢNH NGANG theo MaCoSo';

-- ============================================================
-- 3. BẢNG PhongHoc - Phòng học cơ sở Ngọc Trục
-- Phân mảnh ngang theo MaCoSo = 'NGOCTRUC'
-- ============================================================
...
COMMENT ON TABLE PhongHoc IS 'Phòng học cơ sở NGOCTRUC - PHÂN MẢNH NGANG theo MaCoSo';

-- ============================================================
-- 4. BẢNG LopHocPhan - Lớp học phần MỞ TẠI Ngọc Trục
...
COMMENT ON TABLE LopHocPhan IS 'Lớp học phần mở tại NGOCTRUC - PHÂN MẢNH theo cơ sở MỞ LỚP';
...
-- GHI CHÚ CẤU HÌNH
-- ============================================================
COMMENT ON COLUMN SinhVien.MaCoSo IS 'Cơ sở quản lý chính: NGOCTRUC';
COMMENT ON COLUMN GiangVien.MaCoSo IS 'Cơ sở quản lý chính: NGOCTRUC';
COMMENT ON COLUMN PhongHoc.MaCoSo IS 'Cơ sở sở hữu phòng: NGOCTRUC';
COMMENT ON COLUMN LopHocPhan.MaCoSo IS 'Cơ sở MỞ LỚP này: NGOCTRUC';
